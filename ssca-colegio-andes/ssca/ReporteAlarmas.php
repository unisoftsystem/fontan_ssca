...
<h2 align="right" style="margin-top:2%; margin-right:2%; color:#00C">REPORTE DE ALARMAS</h2>
	<?php
		...
		.done(function( data ) {
			...
			if($.trim(data) != "[]"){
				...
				$.each(jsonUsuario, function(i, item) {
					var tipoDato = "";
					switch($.trim(jsonUsuario[i].tipo)){
						case "ALERTEACORREO":
							tipoDato = "Recogida fuera de sitio";
							break;
						case "ALERTEAPP":
							tipoDato = "Mensaje del monitor al estudiante";
							break;
						case "ALERTEARETRASO":
							tipoDato = "RETRASO EN EL PAGO";
							break;
					}
					if((i + 1) % 2 == 1){
