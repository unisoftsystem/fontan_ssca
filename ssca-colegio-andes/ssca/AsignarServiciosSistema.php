...
<body id="bodyBase">
        ...
        <h2 align="right" style="margin-top:2%; margin-right:2%; color:#09C">Creaci&oacute;n de Usuarios</h2>
        <div id='cssmenu'>
            <ul>
        ...
        <div class="contenidoBorde">
            <form id="commentForm" method="post" action="#" style="height:100%">
                <table style="padding-left:4%; padding-top:4.5%;padding-right:20px;position:absolute" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                        <td colspan="2">&nbsp;</td>
                        <td colspan="4" align="right"><button type="submit" style="width:120px; border-radius:6px; height:30px;background-color:#069;color:#FFF;font-size:10px" name="btnCrearUsuario" id="btnCrearUsuario">Crear Usuario</button></td>
                        <td>&nbsp;</td>
                        <td align="center">&nbsp;</td>
                    </tr>
                    <tr>
