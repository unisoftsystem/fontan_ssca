...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  ...
  <body>
    ...
    <center><h3> Reporte Tendencias Dia</h3></center>
    ...
    <div class="css_bar_graph">
      ...
      //realizo la consulta
      $consulta="SELECT * FROM  `movimientos` INNER JOIN ordenpedido ON movimientos.idCredencial = ordenpedido.idCredencial WHERE DAY( FechaMovimiento ) = DAY( CURRENT_date ) GROUP BY  `DescripcionPedido` ORDER BY  `DescripcionPedido` DESC LIMIT 0 , 10";
      $consulta=mysql_query($consulta, $conexion);


      $consultaqrt="create temporary table temps2(valor int(11) not null,descripcion varchar(500))";
      ...
      //inserto en tabla
      mysql_query("INSERT INTO temps2 (valor, descripcion) VALUES ('".$resultado."','".$resultado2."')") or die(mysql_error());
      }

      
      }
      //realizo consulta de datos modificados y enviados a temp
      $consulta5="SELECT SUM(Valor) AS TOTAL, descripcion FROM temps2 where descripcion = descripcion and valor != 0 GROUP BY `descripcion` ORDER BY `TOTAL` DESC limit 0,10";
      ...
      //realizo consulta de datos modificados y enviados a temp2
      $consulta6="SELECT SUM(valor) AS TOTAL, descripcion FROM temps2 where descripcion = descripcion and valor != 0 GROUP BY `descripcion` ORDER BY `TOTAL` DESC limit 0,10";
