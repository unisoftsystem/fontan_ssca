...
<?php 
	...
	*/
	...
	$resultUsuarioModificado = $controller_Usuario->ModificarUsuario($dataUsuario);	
	
	$resultCredenciales = $controller_Credenciales->CambiarFechaVencimiento($fechaVencimiento, $usuario);	
