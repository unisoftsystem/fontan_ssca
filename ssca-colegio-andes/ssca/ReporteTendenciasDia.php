...
<?php
    ...
    // mysql select
    $result = mysql_query("SELECT * FROM  `movimientos` INNER JOIN ordenpedido ON movimientos.idCredencial = ordenpedido.idCredencial WHERE DAY( FechaMovimiento ) = DAY( CURRENT_date ) GROUP BY  `DescripcionPedido` ORDER BY  `DescripcionPedido` DESC LIMIT 0 , 10");         
?>
<!doctype html>
<html>
    <head>
    ...
    <body id="bodyBase">
      ...
      <div align="right">
      <h3>Tendencia de Consumo Dia&nbsp;&nbsp;&nbsp;</h3>
      </div>
      </br>
      <div align="right">
