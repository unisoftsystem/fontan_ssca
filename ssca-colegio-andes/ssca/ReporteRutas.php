...
<h2 align="right" style="margin-top:2%; margin-right:2%; color:#00C">REPORTE DE RUTAS</h2>
	<?php
        	...
        	<table id="demo" width="100%">
                <thead>
                    <tr>
                        ...
                        <th align="center">Documento del Estudiante</th>
                        <th align="center">Estudiante</th>
                        <th align="center">Curso</th>
                        <th align="center">Marca Vehiculo</th>
                        <th align="center">Placa Vehiculo</th>
                        <th align="center">N&uacute;mero de Sillas</th>
                    </tr>
                </thead>
                <tbody id="tbody">
			...
			if($.trim(data) != "[]"){
				...
				$.each(jsonUsuario, function(i, item) {
					if((i + 1) % 2 == 1){
						...
						'<td align="center">' + jsonUsuario[i].Ruta + '</td>' +
						'<td align="center">' + jsonUsuario[i].NombreMonitor + ' ' + jsonUsuario[i].ApellidoMonitor + '</td>' +
						'<td align="center">' + jsonUsuario[i].ConductorNombre + ' ' + jsonUsuario[i].ConductorApellido + '</td>' +
						'<td align="center">' + jsonUsuario[i].NumeroIdEstudiante + '</td>' +
						'<td align="center">' + jsonUsuario[i].PrimerNombreEstudiante + ' ' + jsonUsuario[i].SegundoNombreEstudiante + ' ' + jsonUsuario[i].PrimerApellidoEstudiante + ' ' + jsonUsuario[i].SegundoApellidoEstudiante + '</td>' +
						'<td align="center">' + jsonUsuario[i].CursoEstudiante + '</td>' +
						'<td align="center">' + jsonUsuario[i].VehiculoMarca + '</td>' +
						'<td align="center">' + jsonUsuario[i].VehiculoPlaca + '</td>' +
						'<td align="center">' + jsonUsuario[i].VehiculoSillas + '</td>' +
						'</tr>';						
					}else{
