...
<head>
<meta charset="utf-8">
<title>REPORTE DE MENSAJES A ACUDIENTES</title>
...
<h2 align="right" style="margin-top:2%; margin-right:2%; color:#00C">REPORTE DE MENSAJES A ACUDIENTES</h2>
	<?php
        ...
        <div class="contenidoBorde">
        	<table id="demo" width="100%">
                <thead>
                    <tr>
                        <th align="center">Tipo de Mensaje</th>
                        <th align="center">Acudiente</th>
                        <th align="center">Documento Estudiante</th>
...
<script type="text/javascript">
	...
	*/
	...
	function init(){
		...
		$.post("ActionReporteMensajesaAcudientes.php", {})
		.done(function( data ) {
			...
			if($.trim(data) != "[]"){
				...
				$.each(jsonUsuario, function(i, item) {
					var tipoDato = "";
					if($.trim(jsonUsuario[i].tipo) == "MENSAJEAACUDIENTESPORESTUDIANTE"){
						tipoDato = "Mensaje a un acudiente de estudiante";
					}else{
						tipoDato = "Mensaje a todos los acudientes de ruta";
					}
					if((i + 1) % 2 == 1){
						html += '<tr class="even" validrow="true">' +
						'<td align="center">' + tipoDato + '</td>' +
						'<td align="center">' + jsonUsuario[i].NombreAcudiente + '</td>' +
						'<td align="center">' + jsonUsuario[i].NumeroId + '</td>' +
						...
						'<td align="center">' + jsonUsuario[i].hora + '</td>' +
