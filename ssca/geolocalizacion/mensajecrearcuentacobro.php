...
<html>
    ...
    <?php
         ...
         require_once '/db_connect1.php';
            ...
            $result = mysql_query("INSERT INTO cuenta_cobro(descripcion,area,tercero,fecha_generacion,fecha_corte,valor_cuenta,desc1,desc2,desc3,desc4,valor_total) VALUES('".$valor."', '".$valor1."', '".$valor2."', '".$valor3."' , '".$valor4."', '".$valor5."', '".$valor6."', '".$valor7."', '".$valor8."', '".$valor9."', '".$valor10."')");
