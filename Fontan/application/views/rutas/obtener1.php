    ...
    <form class="cmxform" method="POST" action="" id="">
      <div class="row">
        <div class="col-md-12" style="background-color: #f5f5f5; padding-top: 10px; padding-bottom: 10px" align="center">
            <img src="<?= base_url();?>img/HOME.png" width="200" height="100" border="0" style="left:15px; position:absolute; top: 0px">
            <a href="<?= base_url();?>index.php/rutas/nuevo"><img src="<?= base_url();?>img/logo1.png" width="70" height="70"></a>&nbsp; 
            <a style="top:40px; position: relative;" href="<?= base_url();?>index.php/rutas/obtener"><img src="<?= base_url();?>img/logo2.png" width="70" height="70" border="0"></a>
            <a href="<?= base_url();?>index.php/rutas/editar"><img src="<?= base_url();?>img/logo3.png" width="70" height="70" border="0"></a>
            <a href="#" id="OpcionSalir"><img src="<?= base_url();?>img/exit.png" width="70" height="70" border="0"></a><br>
        </div>
      </div>
          ...
          .done(function( data ) {console.log(data)
            ...
            if($.trim(data) != "[]"){
              ...
              marker = new google.maps.Marker({
                ...
                icon: '<?= base_url();?>img/icon-bus.png',
