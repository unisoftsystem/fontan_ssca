    ...
    <form class="cmxform" method="POST" action="" id="">
      <div class="row" style="margin-top: -20px">
        <div class="col-md-12" style="background-image: url('<?= base_url();?>img/www logo rutas escolares.png'); background-repeat: no-repeat; background-size: 100% 100%; padding-top: 10px; padding-bottom: 10px; height: 192px" align="center">
            ...
            <a style="position: absolute; bottom: -30px; right: 410px; border: 5px solid #f59540; border-radius: 100%; padding: 0px" href="<?= base_url();?>index.php/rutas/nuevo"><img src="<?= base_url();?>img/www creacion ruta escolar.png" width="100px" height="100px"></a>&nbsp;
              ...
              <div id="container-player">
                ...
                <!--<div class="drag" id="1">                  
                  <div class="col-md-11" align="center" style="padding: 0px; margin: 0px">
                    <img width="58px" src="<?= base_url();?>images/56d9b9c572926.png">
