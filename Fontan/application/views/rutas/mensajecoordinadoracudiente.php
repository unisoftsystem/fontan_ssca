      ...
      <div class="contenidoBorde">
         ...
         <div class="container-fluid" style="padding: 0">
            ...
            <table id="demo" width="100%">
                    ...
                    <tr>
                        <td align="center">Tipo de Mensaje</td>   
                ...
                <tbody>
                        ...
                        */                                    
                        if($mensajes){
                            ...
                            foreach ($mensajes->result() as $value) {
                                ...
                                $tipoDato = "";
                                if($value->tipo == "MENSAJEAACUDIENTESPORESTUDIANTE"){
                    ...
                    ?>    
                        <tr align="center">     
                            <td width="12.5%"><?= $tipoDato;?></td>
                            <td width="12.5%"><?= $value->NombreAcudiente;?></td>
                            <td width="12.5%"><?= $value->NumeroId;?></td>
                            <td width="12.5%"><?= $value->PrimerNombre . " " . $value->SegundoNombre . " " . $value->PrimerApellido . " " . $value->SegundoApellido;?></td>
                            <td width="12.5%"><?= $value->nombreruta;?></td>
                            <td width="12.5%"><?= $fechaDato;?></td>
                            <td width="12.5%"><?= $value->hora;?></td>
                            <td width="12.5%"><?= $value->mensaje;?></td> 
                        </tr>
                    <?php
