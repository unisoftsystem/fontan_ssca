    ...
    <ul class="nav navbar-nav windowHidden" style="display: none;">                
          ...
          <form class="cmxform" method="POST" action="">
            <div class="row">
              ...
              <div class="col-md-6" style="margin-left: 25%">
                ...
                <div class="form-group" id="rowsubcategoria" style="display:none">
      ...
      $.validator.setDefaults({
        ...
        submitHandler: function() {
          ...
          $.post("<?= base_url();?>index.php/categoria/modificar", datos)
          .done(function( data ) {
            alert("¡Se actualizo con exito los datos!")
            window.location.href = "<?= base_url();?>index.php/categoria/editar";
          });
      ...
      $("#selectTipo").change(function(e) {
        ...
        switch($("#selectTipo").val()){
          case "Subcategoria":
            ...
            $( "#rowsubcategoria" ).css( "display", "none" );
      ...
      $("#selectCategoria").change(function(e) {
        ...
        if($("#selectTipo").val() == "Categoria"){
          $( "#rowsubcategoria" ).css( "display", "none" );
          if($("#selectCategoria").val() != "Seleccione"){
            $("#txtNombre").val($("#selectCategoria option:selected").text());
           
          }else{
            $("#txtNombre").val("");
          }
        }else{
          if($("#selectTipo").val() == "Subcategoria"){
            $("#txtNombre").val("");
            $( "#rowsubcategoria" ).css( "display", "block" );
      ...
      $("#selectSubcategoria").change(function(e) {
      if($("#selectSubcategoria").val() != "Seleccione"){
          $("#btnGuardar").css( "display", "block" );
            $("#txtNombre").val($("#selectSubcategoria option:selected").text());
      }else{
        $("#btnGuardar").css( "display", "none" );
        $("#txtNombre").val("");
      }
