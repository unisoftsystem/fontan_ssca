...
<body id="">
    ...
    <div class="container-fluid" style="top:82px;background-image:url(../../img/pagocafeteria.png); background-repeat:no-repeat; background-size: cover;width: 100%; position: absolute;" id="body"><br><br>
        <div class="row" style="">  
        ...
        <div class="row">
            <div class="col-md-12 menu" align="center" style="">
                ...
                <a href="../inicio/tarjeta"><img class="select" src="../../img/btn tarjeta monedero.png" width="94px"></a>
        ...
        <div class="row" style="">
            <div class="col-md-4" style="background: #000; opacity: .4; padding: 15px 35px 140px 25px; color: #fff; opacity: .3; letter-spacing: 2px;">
                <h3 style="font-family: Arial; opacity: 4;">TARJETAS MONEDERO</h3><br>
                <p style="opacity: 1; font-family: Arial">Ahora su identificación estudiantil se convierte en un medio de pago</p>
                <ul style="margin-left: 10%; list-style-type: none;" class="textoPage">
                    <li>La perfecta comodidad sin efectivo</li>
                    <li>100% seguro</li>
                    <li>Reemplazo inmediato en caso de perdida</li>
                    <li>Reportes y extractos</li>
                    <li>Recargues monetarios en línea</li>
                    <li>Módulo de administración y seguimiento</li>
                </ul>
