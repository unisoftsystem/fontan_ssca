...
<body id="">
    ...
    <div class="container-fluid" style="top:82px;background-image:url(../../img/SscaRestaurante.png); background-repeat:no-repeat; background-size: cover;width: 100%; position: absolute;" id="body"><br><br>
        <div class="row" style="">  
        ...
        <div class="row">
            <div class="col-md-12 menu" align="center" style="">
                ...
                <a href="../inicio/restaurante"><img class="select" src="../../img/btn restaurante.png" width="94px"></a>
        ...
        <div class="row" style="">
            <div class="col-md-4" style="background: #000; opacity: .4; padding: 15px 35px 140px 25px; color: #fff; opacity: .3; letter-spacing: 2px;">
                <h3 style="font-family: Arial; opacity: 4;">CONTROL<br>para RESTAURANTE ESCOLAR</h3><br>
                <p style="opacity: 1; font-family: Arial">Administra, controla y supervisa de manera sencilla los procesos de aliemetacion de tu hijo </p>
                <ul style="margin-left: 10%; list-style-type: none;" class="textoPage">
                    ...
                    <li>Talonarios Virtuales</li>
                    <li>Credenciales Monedero</li>
                    <li>Restricciones de consumo</li>
                    <li>Información actualizada de menu´s</li>
                </ul>
