                    ...
                    if($.trim(arl) != ""){
                        if(clave == reclave){
                            if($.trim(fechaVencimiento) != ""){
                                ...
                                $.post("<?= base_url();?>index.php/monitores/editarMonitor", datos)
                                .done(function( result ) {console.log(result)
                                    alert("¡Se actualizó con exito el monitor!");                         
                                    ...
                                    lng = '';
                                    initialize()
                                    window.location.href = "<?= base_url();?>index.php/monitores/editar";
            ...
            */
            $("#txtNumeroId").keyup(function(e) {
                ...
                /*
                    ...
                    La funcion base_url() obtiene la url base del proyecto, la cual es configurada en el archivo config.php
                */
                $.post("<?= base_url();?>index.php/monitores/ConsultarMonitor", datos)
                .done(function( data ) {
