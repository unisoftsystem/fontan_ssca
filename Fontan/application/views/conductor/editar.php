                    ...
                    <input type="hidden" id="txtUserId" name="txtUserId" value="<?= $this->session->userdata('UserIDInternoSSCA');?>" />      
                        ...
                        <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="row" id="rowCredencial">
                                            <div class="col-md-3" align="right">
                    ...
                    if($.trim(arl) != ""){
                        if(clave == reclave){
                            if($.trim(fechaVencimiento) != ""){
                                ...
                                $.post("<?= base_url();?>index.php/conductores/editarConductor", datos)
                                .done(function( result ) {
                                    alert("¡Se actualizó con exito el conductor!");                         
                                    ...
                                    lng = '';
                                    initialize()
                                    window.location.href = "<?= base_url();?>index.php/conductores/editar";
            ...
            */
            $("#txtNumeroId").keyup(function(e) {
                ...
                /*
                    ...
                    La funcion base_url() obtiene la url base del proyecto, la cual es configurada en el archivo config.php
                */
                $.post("<?= base_url();?>index.php/conductores/ConsultarConductor", datos)
                .done(function( data ) {
