...
<link rel="stylesheet" media="all" type="text/css" href="<?= base_url();?>lib/timepicker/jquery-ui-timepicker-addon.css" />
<style>  
...
<body id="bodyBase">
    ...
    <ul class="nav navbar-nav windowHidden" style="display: none;">                
      ...
      <script type="text/javascript" src="<?= base_url();?>lib/timepicker/jquery-ui-timepicker-addon.js"></script>
      <script type="text/javascript" src="<?= base_url();?>lib/timepicker/jquery-ui-sliderAccess.js"></script>
