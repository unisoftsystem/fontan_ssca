...
<body id="bodyBase">
    ...
    <form class="cmxform" id="commentForm" method="post" action="">
      ...
      $.validator.setDefaults({
        ...
        $.post("<?= base_url();?>index.php/movimientos/GenerarReportePermisosSalidas", datos)
        .done(function( data ) {
          ...
          if($.trim(data) != "[]"){
            ...
            $.each(jsonUsuario, function(i, item) {
              ...
              if((i + 1) % 2 == 1){
                ...
                '<td>' + jsonUsuario[i].Observaciones + '</td>' +
                '</tr>';            
      ...
      (function() {
        ...
        $("#commentForm").validate({
         ...
         $("#btnExportarReporte").click(function(e) {
          ...
          var fechaInicial = $("#dateFechaInicial").val();
          var fechaFinal = $("#dateFechaFinal").val();
          var win = window.open("<?= base_url();?>index.php/movimientos/ExportarSalidas?usuario=" + usuarioSeleccionado + "&fechaInicial=" + fechaInicial + "&fechaFinal=" + fechaFinal, '_blank');
          win.focus(); 
