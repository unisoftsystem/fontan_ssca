...
<body id="bodyBase">
    ...
    <form class="cmxform" id="commentForm" method="post" action="">
      ...
      $.validator.setDefaults({
        ...
        $.post("<?= base_url();?>index.php/movimientos/GenerarReporteDevoluciones", datos)
        .done(function( data ) {
      ...
      (function() {
        ...
        $("#btnExportarReporte").click(function(e) {
          ...
          var fechaInicial = $("#dateFechaInicial").val();
          var fechaFinal = $("#dateFechaFinal").val();
          var win = window.open("<?= base_url();?>index.php/movimientos/ExportarReporteDevoluciones?usuario=" + usuarioSeleccionado + "&fechaInicial=" + fechaInicial + "&fechaFinal=" + fechaFinal, '_blank');
          win.focus(); 
