                ...
                <div class="container-fluid">
                        ...
                        <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="row" style="">
                                            <div class="col-md-3" align="right">
                                               <label for="selectTipoFuncionario" style="margin-top:5px"><font color="#09C" size="2">Motivo de reemplazo</font></label>
                                            </div>
                                            <div class="col-md-2">
                                                <input type = "radio" name="radioMotivo" id="radioMotivoDeterioro" class="form-control" value="DETERIORO" checked="checked" />
                                              
                                            </div>
                                            <div class="col-md-5" align="left">
                                                <label for="radioMotivoDeterioro" style="margin-top:15px"><font color="#09C" size="2">DETERIORO</font></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2" style="margin-top:-7px">
                                                <input type="radio" name="radioMotivo" id="radioMotivoPerdida" class="form-control" value="PERDIDA"/>
                                              
                                            </div>
                                            <div class="col-md-5" align="left">
                                                <label for="radioMotivoPerdida" style="margin-top:5px"><font color="#09C" size="2">PERDIDA</font></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <input type = "radio" name="radioMotivo" id="radioMotivoOtros" style="margin-top:10px" class="form-control" value="OTROS"/>   
                                            </div>
                                            <div class="col-md-7" align="left">
                                                <label for="radioMotivoOtros" style="margin-top:17px"><font color="#09C" size="2">OTROS</font></label><br>
                                                <input type="text" id="txtOtroMotivo" name="txtOtroMotivo" class="form-control" />
                                                <?php
                                                    $attributesError = array(
                                                        'id' => 'lblErrorOtro',
                                                        'style' => 'display: none;',
                                                    ...
                                                    echo form_label("", "txtOtroMotivo", $attributesError);
                                                ?>  
                                            </div>
                                        </div><br>
            ...
            $.validator.setDefaults({
                submitHandler: function() {
                    ...
                    */
                    ...
                    if(motivo == "OTROS"){
                        if($.trim($("#txtOtroMotivo").val()).length > 0){
                            $("#btnGuardar").attr("disabled", "disabled")
                            $.post("<?= base_url();?>index.php/credenciales/CrearReemplazoCredencial", datos)
                            .done(function( result ) {console.log(result)
                                ...
                                if(jsonUsuario.length > 0){
                                    $.each(jsonUsuario, function(i, item) {
                                        ...
                                        if(jsonUsuario[i].tipo == "ESTUDIANTE" || jsonUsuario[i].tipo == "FUNCIONARIO"){
                                            //alert("Se ingreso con exito el usuario");                                          
                                            var win = window.open("<?= base_url();?>index.php/credenciales/carnet", '_blank');
                                            win.focus();    
                                            borrarTodo()                
                                        }else{
                                            var win = window.open("<?= base_url();?>index.php/credenciales/CarnetFuncionario", '_blank');
                                            win.focus();                      
                                            borrarTodo()
                                        }
                            ...
                            $("#lblErrorOtro").css({"display":"block"})
                            $("#lblErrorOtro").html("Debe ingresar el motivo del reemplazo de la credencial")
                        }
                    }else{
                        $("#btnGuardar").attr("disabled", "disabled")
                        $.post("<?= base_url();?>index.php/credenciales/CrearReemplazoCredencial", datos)
