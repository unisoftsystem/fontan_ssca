...
class Rutas extends CI_Controller {
	...
	function nuevo(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/nuevo', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
	...
	function editar(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/editar', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function obtener(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/obtener', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function chatMonitor(){
		...
		if($validacion > 0){
			...
			$this->load->view('chat/mensajeMonitor', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function chatAcudiente(){
		...
		if($validacion > 0){
			...
			$this->load->view('chat/chatAcudiente', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function bitacora(){
		...
		if($validacion > 0){
			//Se cargan los menus de los modulos, submodulos y servicios que estan en el controller services
			$this->load->library('../controllers/services');
			$data['menuPrincipal'] = $this->services->menuModulos(
				$this->session->userdata('UserIDInternoSSCA'), 
				$this->session->userdata('SegmentoTextoModulo')
			);	
			$data['menuServicios'] = $this->services->menuServicios(
				$this->session->userdata('UserIDInternoSSCA'),
				"",
				$this->session->userdata('SegmentoCodigoModulo')
			);
			//Se llama a la funcion de que esta en modelo y el resultado se guarda en la variable
			$data['rutas'] = $this->rutas_model->listar();
			//Titulo de la pagina, se lo envio al archivo donde esta el header
			$data['titulo'] = "Bitacora de Ruta Escolar";
			$this->load->view('header', $data);//Se muestra en el navegador primero el header con titulo y demas cosas agregada
			$datos_footer = [ 'logo' => "img/logo app.png" ];
			$array_page = [ 'footer' =>  $this->load->view('footerPages', $datos_footer, true) ];
			//Se carga la vista que esta dentro de la carpeta
			$this->load->view('rutas/bitacora', $array_page);
		}else{
			header('Location:'.base_url().'index.php/usuarios_sistema/homeInternoModulos', true, 403);
			//echo "<script>window.location.href = '" . base_url(1) . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function mensajeacudienteamonitor(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/mensajeacudienteamonitor', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function mensajecoordinadoracudiente(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/mensajecoordinadoracudiente', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function enviarmensajeacudientes(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/enviarmensajeacudientes', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function mensajes_predefinidos(){
		//Se valida si la pagina a acceder esta dentro de los pemisos del usuario que ha iniciado sesion
		/*$validacion = $this->permisos_usuarios_sistema_model->verificarPagina("../rutas/mensajes_predefinidos", $this->session->userdata('UserIDInternoSSCA'));	
		...
		if($validacion > 0){*/
			...
			$this->load->view('rutas/mensajes_predefinidos', $array_page);//Se carga la vista que esta dentro de la carpeta
		/*}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}*/
	}
	...
	function todos(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/todos', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function calendariomonitores(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/monitoresebruta', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function admintraslados(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/admintraslados', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
	...
	function calendariovehiculos(){
		...
		if($validacion > 0){
			...
			$this->load->view('rutas/vehiculosruta', $array_page);//Se carga la vista que esta dentro de la carpeta
		}else{
			echo "<script>window.location.href = '" . base_url() . "index.php/usuarios_sistema/homeInternoModulos';</script>";//Se redirecciona a la pagina del home cuando el usuario que ha iniciado sesion no tiene permiso sobre la pagina que intenta ingresar
		}
	}
