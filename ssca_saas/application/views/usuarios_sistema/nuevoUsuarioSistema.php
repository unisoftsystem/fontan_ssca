        ...
        <script>
    		...
    		function init(){
                ...
                if(navigator.getUserMedia){
                    ...
                    video.play();
                },function(e){console.log(e);$("#t").css({"display":"none"})});
                ...
                submitHandler: function() {
                    ...
                    */
                    ...
                    if(permisos != ""){
                        ...
                        $.post("<?= base_url();?>index.php/usuarios_sistema/crearUsuario", datos)
                        .done(function( result ) {
                            alert("¡Se ingreso con exito el usuario!");                         
                            window.location.href = "<?= base_url();?>index.php/usuarios_sistema/AsignarServiciosSistema";
                        });
                    }else{
            ...
            */
            $("#txtNumeroId").keyup(function(e) {
                ...
                /*
                    ...
                    La funcion base_url(1) obtiene la url base del proyecto, la cual es configurada en el archivo config.php
                */
                $.post("<?= base_url();?>index.php/usuarios_sistema/ExisteDocumentoUsuario", datos)
                .done(function( data ) {
                    if($.trim(data) == "1"){
