<?php
    ...
    if(!empty($UserName)) { // Recuerda usar corchetes.
        header('Location: ' . base_url(1) . "index.php/usuarios_sistema/homeInternoModulos");
    } 
    $pedido = $this->session->userdata('PedidoSSCASESSION');
    if($pedido != "[]" && $pedido != null && $pedido != "") { // Recuerda usar corchetes.
        header("Location: " . base_url(1) . "index.php/ordenpedido/borrarSesionTodo?session=" . $this->session->userdata('UserIDInternoSSCA'));
...
<body id="bodyLogin" onload="nobackbutton();">
        ...
        <div class="footer" align="right" id="footer">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-4" align="right">
                                <img src="<?= base_url(1);?>images/UserName.png" width="80" style="opacity:.9"/>
                            </div>
                        ...
                        <div class="row" style="margin-top: 5px">
                            <div class="col-md-4" align="right">
                                <img src="<?= base_url(1);?>images/Password.png" width="80" style="opacity:.9 "/>
                            </div>
                            <div class="col-md-8" align="left">
                        ...
                        <div class="row">
                            <div class="col-md-12" align="right">
                                <button type="submit" id="btnIngresar" name="btnIngresar"><img src="<?= base_url(1);?>images/Ingresar.png" width="80" style="opacity:.9 "/></button>
                            </div>
                        </div>                            
                    </div>
