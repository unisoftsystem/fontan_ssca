        ...
        <div class="container-fluid" style="padding: 0">
            ...
            <form class="cmxform" id="commentForm" method="get" action="">
                ...
                <div class="row" align="right"" style="width:99%">
                    <div class="col-md-12">
                        <button class="btn btn-primary" type="submit" id="btn_enviar_mensaje">Crear Mensaje</button>
                    </div>
                </div>
            </form>
        </div>
      ...
      <script type="text/javascript">
        ...
        $.validator.setDefaults({
            ...
            submitHandler: function() {
                if($("#btn_enviar_mensaje").html() == "Crear Mensaje"){
        ...
        $("#select_mensaje").change(function(e){
            if($(this).val() != "Seleccione"){
                ...
                $("#btn_enviar_mensaje").html("Crear Mensaje")
