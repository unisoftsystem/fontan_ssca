  ...
  <button type="button" id="btnConsultarRecorrido" class="btn btn-primary" style="display:none;float: right; margin-right: 3%">Consultar Recorrido Grafico</button>            
    ...
    <?= $footer;?>
      <script src="http://190.60.211.17:3003/socket.io/socket.io.js"></script>
        <script type="text/javascript" src="<?php echo base_url(1) ?>/js/chat.js"></script>
            ...
            .done(function( data ) {//console.log(data)
              if($.trim(data) != "[]"){
                ...
                $.each(json, function(i, item) {
                  ...
                  $("#tbody").append('<tr align="center"><td>' + json[i].PrimerApellido + ' ' + json[i].SegundoApellido + ' ' + json[i].PrimerNombre + ' ' + json[i].SegundoNombre + '</td><td>' + json[i].HoraRecogido + '</td><td>' + json[i].HoraEntregado + '</td><td>' + mensajes + '</td></tr>');
      ...
      <!-- =====================================
        MANGER TAB BITACORA
      ===================================== -->
      <script src="<?php echo base_url(1).'js/BitacoraRuta.js' ?>"></script> 
