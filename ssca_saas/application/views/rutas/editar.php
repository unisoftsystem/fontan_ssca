    ...
    <form class="cmxform" method="POST" action="" id="">
      <div class="row" style="margin-top: -20px">
        <div class="col-md-12" style="background-image: url('<?= base_url(1);?>img/www logo rutas escolares.png'); background-repeat: no-repeat; background-size: 100% 100%; padding-top: 10px; padding-bottom: 10px; height: 192px" align="center">
            ...
            <a style="position: absolute; bottom: -6px; right: 410px" href="<?= base_url();?>index.php/rutas/nuevo"><img src="<?= base_url(1);?>img/www creacion ruta escolar.png" width="100px" height="100px"></a>&nbsp;

            <a style="position: absolute; bottom: -30px; right: 300px; border: 5px solid #f59540; border-radius: 100%; padding: 0px" href="<?= base_url();?>index.php/rutas/editar"><img src="<?= base_url(1);?>img/www modificarcion ruta escolar.png" width="100px" height="100px" border="0"></a>
                ...
                $("#container-field > div").append('<div class="drag" id="' + jsonUsuario[i].NumeroId + '">' +
                  ...
                  '<div class="col-md-1" style="padding: 0px; margin: 0px">' +
                    '<a class="boxclose" id="back' + jsonUsuario[i].NumeroId + '" document="' + jsonUsuario[i].NumeroId + '" nombre="' + jsonUsuario[i].PrimerNombre + ' ' + jsonUsuario[i].PrimerApellido + '" direccion="' + jsonUsuario[i].Direccion + '">' +
                      '<img src="<?= base_url(1);?>img/izq.png" width="20">' +
                    '</a>' +
                  '</div>' +
                '</div>')       
