    ...
    <form class="cmxform" method="POST" action="" id="">
      <div class="row" style="margin-top: -20px">
        <div class="col-md-12" style="background-image: url('<?= base_url(1);?>img/www logo rutas escolares.png'); background-repeat: no-repeat; background-size: 100% 100%; padding-top: 10px; padding-bottom: 10px; height: 192px" align="center">
            ...
            <a style="position: absolute; bottom: -30px; right: 190px; border: 5px solid #f59540; border-radius: 100%; padding: 0px" href="<?= base_url();?>index.php/rutas/obtener"><img src="<?= base_url(1);?>img/www tracking ruta escolar.png" width="100px" height="100px" border="0"></a>
          ...
          .done(function( data ) {console.log(data)
            ...
            if($.trim(data) != "[]"){
              ...
              marker = new google.maps.Marker({
                ...
                icon: '<?= base_url(1);?>img/Bus_tracking.png',
            ...
            if($.trim(data) != "[]"){              
              ...
              for (var i = 0; i < json.length; i++) {
                ...
                var marker3 = new google.maps.Marker({
                  map: map2,//el mapa creado en el paso anterior
                  position: latLng,//objeto con latitud y longitud
                  icon: '<?= base_url(1);?>images/circle_yellow.png',
                  draggable: false //que el marcador se pueda arrastrar
                });
              ...
              for (var i = 0; i < json.length; i++) {
                ...
                switch(json[i].mensaje){
                  case "ALERTA DE ACCIDENTE":
                    icono = "<?= base_url(1);?>img/AlertaAccidente.png";
                    break;
                  case "INCIDENTE MECANICO":
                    icono = "<?= base_url(1);?>img/AlertaFallaMecanica.png";
                    break;
                  case "TRÁFICO LENTO":
                    icono = "<?= base_url(1);?>img/AlertaTraficoLento.png";
                    break;
                  case "DAÑO DE NEUMATICO":
                    icono = "<?= base_url(1);?>img/AlertaDanoNeumatico.png";
                    break;
                }
