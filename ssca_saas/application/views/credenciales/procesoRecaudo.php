...
<script src="<?= base_url(1);?>js/html5-qrcode.min.js"></script>
<script>
...
<body id="bodyBase">
         ...
         <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-8">  
                ...
                <div class="col-md-4">
                  ...
                  <label for="txtRecarga"><font color="#09C" size="2">Valor de recarga:</font></label>
                  <input type="text" name="txtRecarga" id="txtRecarga" min="1" onKeyUp="format(this)" class="form-control"/><br>

                  <button type="submit" name="btnIngresar" id="btnIngresar" class="btn btn-primary" style="float: right;display:none"><b>Realizar Recarga</b></button><br><br><br>
          ...
          <div id="popup" style="display: none;">
            <div class="content-popup">
              <div class="close"><a href="#" id="close"><img src="<?= base_url(1);?>images/close.png"/></a></div>
    ...
    <?= $footer;?>
      ...
      $('#close').click(function(){
         ...
         window.location.href = "<?= base_url();?>index.php/credenciales/procesoRecaudo";
          return false;
      }); 
        ...
        submitHandler: function() {
          ...
          */
          ...
          //if(parseInt(vaux) >= 20000){
            ...
            $.post("<?= base_url();?>index.php/credenciales/ProcesarRecaudo", usuario)
            .done(function( data ) {
              ...
              if($.trim(data) != "[]"){
                ...
                $.each(json, function(i, item) {
                  ...
                  $("#foto").attr("src", "<?= base_url(1);?>" + json[i].ImagenFotografica);
                });
                $("#Datos").html(html);
                $('#popup').fadeIn('slow');
              }
