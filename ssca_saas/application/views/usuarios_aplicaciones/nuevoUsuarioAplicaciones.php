                        ...
                        <div class="row">
                            <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <select name="selectTipoUsuario" id="selectTipoUsuario" class="form-control">
                                        ...
                                        <div class="row" style="display:none" id="rowCredencial">
                                            <div class="col-md-3" align="right">
                                               <label for="txtRecarga"><font color="#09C" size="2">Valor Base de Re-Carga</font></label>
                                            </div>
                                            <div class="col-md-3">
                                                <input id="txtRecarga" name="txtRecarga" type="text" style="" onKeyUp="format(this)" class="form-control" />
                                                <?php
                                                    $attributesError = array(
                                                        'id' => 'lblErrorRecarga',
                                                        'style' => 'display: none;',
                            ...
                            <div class="col-md-3" align="center" >
                                ...
                                <img id="imageFoto" name="imageFoto" width="100%" src="<?= base_url(1);?>images/person.png" /><br/><br/>
        ...
        <script>
            ...
            $.validator.setDefaults({
                submitHandler: function() {
                    ...
                    fechaVencimiento=fechaVencimiento.replace(new RegExp("/","g") ,"-");
                    var dataURL;
                    if(urlFoto != ""){
                                            ...
                                            if(result != "[]"){
                                                ...
                                                if(jsonUsuario.length > 0){
                                                    $.each(jsonUsuario, function(i, item) {
                                                        ...
                                                        win.focus();
                                                        window.location.href = "<?= base_url();?>index.php/usuarios_aplicaciones/nuevo";                        
                ...
                */
                ...
                .done(function( data ) {
                    if($.trim(data) == "1"){
                        ...
                        $("#lblErrorDocUsuarioPopup").html('El documento de identificación ' + $("#txtNumeroIdPopup").val() + ' ya existe');
                        $("#btnGuardarPopUp").css({"visibility":"hidden"});
                    }else{
