...
<body id="">
    ...
    <div class="container-fluid" style="top:82px;background-image:url(../../img/cafeteria_ssca.png); background-repeat:no-repeat; background-size: cover;width: 100%; position: absolute;" id="body"><br><br>
        <div class="row" style="">  
        ...
        <div class="row">
            <div class="col-md-12 menu" align="center" style="">
                ...
                <a href="../inicio/identificacion"><img src="../../img/btn sistemas de identificacion.png" width="94px"></a>
                ...
                <a href="../inicio/cafeteria"><img class="select" src="../../img/btn cafeteria.png" width="94px"></a>
        ...
        <div class="row" style="">
            <div class="col-md-4" style="background: #000; opacity: .4; padding: 15px 35px 140px 25px; color: #fff; opacity: .3; letter-spacing: 2px;">
                <h3 style="font-family: Arial; opacity: 4;">CONTROL<br>para CAFETERIA ESCOLAR</h3><br>
                <p style="opacity: 1; font-family: Arial">No tome a la ligera la compra y consumo de productos de cafetería por parte de sus hijos</p>
                <ul style="margin-left: 10%; list-style-type: none;" class="textoPage">
                    <li>Sistema eliminación de filas</li>
                    <li>Controles de acceso</li>
                    <li>Validadores de pago</li>
                    <li>Bitácora de consumos</li>
                    <li>Pedidos desde su smartphone</li>
                    <li>Credenciales Monedero</li>
                    <li>Restricciones de consumo por producto</li>
                    <li>Restricciones de consumo por valor</li>
                </ul>
