...
<body id="">
    ...
    <div class="container-fluid" style="top:82px;background-image:url(../../img/CredencialSsca.png); background-repeat:no-repeat; background-size: cover;width: 100%; position: absolute;" id="body"><br><br>
        <div class="row" style="">  
        ...
        <div class="row">
            <div class="col-md-12 menu" align="center" style="">
               <a href="../inicio"><img src="../../img/btn Inicio.png" width="90px"></a>
                <a href="../inicio/identificacion"><img class="select" src="../../img/btn sistemas de identificacion.png" width="94px"></a>
        ...
        <div class="row" style="">
            <div class="col-md-4" style="background: #000; opacity: .4; padding: 15px 35px 140px 25px; color: #fff; opacity: .3; letter-spacing: 2px;">
                <h3 style="font-family: Arial; opacity: 4;">SISTEMAS de<br>IDENTIFICACION</h3><br>
                <p style="opacity: 1; font-family: Arial">Somos expertos en soluciones de identificación, seguridad y personalización de tarjetas</p>
                <ul style="margin-left: 10%; list-style-type: none;" class="textoPage">
                    <li>Tarjetas Code-Reading</li>
                    <li>Tarjetas de proximidad</li>
                    <li>Impresoras de tarjetas de identificación</li>
                    <li>Software y Cámaras ID</li>
                    <li>Accesorios de Identificación</li>
                    <li>Control de acceso de puertas</li>
                    <li>Registro y gestión de visitas</li>
                    <li>Seguimiento de Recorrido</li>
                </ul>
