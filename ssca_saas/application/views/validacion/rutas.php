...
<body id="">
    ...
    <div class="container-fluid" style="top:82px;background-image:url(../../img/rutasSsca.png); background-repeat:no-repeat; background-size: cover;width: 100%; position: absolute;" id="body"><br><br>
        <div class="row" style="">  
        ...
        <div class="row">
            <div class="col-md-12 menu" align="center" style="">
                ...
                <a href="../inicio/rutas"><img class="select" src="../../img/btn ruta escolar.png" width="94px"></a>
        ...
        <div class="row" style="">
            <div class="col-md-4" style="background: #000; opacity: .4; padding: 15px 35px 140px 25px; color: #fff; opacity: .3; letter-spacing: 2px;">
                <h3 style="font-family: Arial; opacity: 4;">CONTROL<br>de RUTAS ESCOLARES</h3><br>
                <p style="opacity: 1; font-family: Arial">Queremos Brindar Tranquilidad en lo más preciado para usted</p>
                <ul style="margin-left: 10%; list-style-type: none;" class="textoPage">
                    <li>Visualización de recorrido en tiempo real</li>
                    <li>Notificación de proximidad a sitio</li>
                    <li>Notificación de ingreso a ruta</li>
                    <li>Notificación de descenso de ruta</li>
                    <li>Comunicación bidireccional al instante</li>
                    <li>Informacion actualizada de personal</li>
