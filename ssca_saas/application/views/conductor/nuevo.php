                    ...
                    */
                    ...
                    if(dataURL != ""){
                        ...
                        if(clave == reclave){
                                ...
                                $.post("<?= base_url();?>index.php/conductores/crearConductor", datos)
                                .done(function( result ) {console.log(result)
                                    alert("¡Se ingreso con exito el conductor!");                         
                                    ...
                                    if(result != "[]"){
                                        ...
                                        if(jsonUsuario.length > 0){
                                            $.each(jsonUsuario, function(i, item) {
                                                ...
                                                win.focus(); 
                                                //window.location.href = "<?= base_url();?>index.php/conductores/nuevo";    
                                            })
                                        }
                                    }else{
                                        window.location.href = "<?= base_url();?>index.php/conductores/nuevo";
