         ...
         <div class="container-fluid">
          ...
          <form class="cmxform" method="POST" action="" id="commentForm">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">  
                    <input type="text" name="marca" id="marca" class="form-control" disabled="disabled"/>
                  </div>
                </div><br/>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">  
                    <input type="text" name="categoria" id="categoria" class="form-control" disabled="disabled"/>
                  </div>
                </div><br/>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">  
                    <input type="text" name="nombreruta" id="nombreruta" class="form-control" disabled="disabled"/>
                  </div>
                </div><br/>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">  
                    <input type="text" name="sillas" id="sillas" class="form-control" onKeyUp="format(this)" disabled="disabled"/>
                  </div>
                </div><br/>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">  
                    <textarea name="observaciones" id="observaciones" class="form-control" disabled="disabled"></textarea>
                  </div>
                </div><br/>
      ...
      <script type="text/javascript">
        ...
        $.validator.setDefaults({
          ...
          submitHandler: function() {
            ...
            $.post("<?= base_url();?>index.php/vehiculos/actualizar", datos)
            .done(function( data ) {console.log(data)
              alert("¡Se actualizo con exito el vehiculo!")
              window.location.href = "<?= base_url();?>index.php/vehiculos/editar";
            });
        ...
        */
        $("#placa").keyup(function(e) {
            ...
            */
            $.post("<?= base_url();?>index.php/vehiculos/obtenerVehiculoPlaca", datos)
            .done(function( data ) {
                if($.trim(data) != "[]"){
                    ...
                    $.each(json, function(i, item) {         
                      ...
                      $("#categoria").val(json[i].categoria)
                      $("#nombreruta").val(json[i].nombre_ruta)
                      $("#sillas").val(json[i].sillas)
                      $("#observaciones").val(json[i].observaciones)

                      $("#marca").removeAttr("disabled"); 
                      $("#categoria").removeAttr("disabled"); 
                      $("#nombreruta").removeAttr("disabled"); 
                      $("#sillas").removeAttr("disabled"); 
                    ...
                    $("#nombreruta").attr("disabled", "disabled"); 
                    $("#sillas").attr("disabled", "disabled"); 
