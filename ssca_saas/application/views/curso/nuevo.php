              ...
              <div class="col-md-6" style="margin-left: 25%">
                ...
                <div class="form-group">
                  ...
                  <?php
                      ...
                      echo form_label("", "txtNombre", $attributesErrorDoc);
                  ?>
                </div>
    ...
    <?= $footer;?>
      ...
      $.validator.setDefaults({
        ...
        submitHandler: function() {
          ...
          $.post("<?= base_url();?>index.php/cursos/crear", datos)
          .done(function( data ) {console.log(data)
            alert("¡Se registro con exito el curso!")
            window.location.href = "<?= base_url();?>index.php/cursos/nuevo";
          });
      ...
      $("#txtNombre").keyup(function(e) {
          ...
          */
          $.post("<?= base_url();?>index.php/cursos/ExisteCurso", datos)
          .done(function( data ) {console.log(data)
              if($.trim(data) == "1"){
                  $("#lblError").css({"display":"block"});
                  $("#lblError").html('El curso ' + $("#txtNombre").val() + ' ya existe');
