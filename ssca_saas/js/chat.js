var URL_SERVER_ADMIN = "http://190.60.211.17/ssca_saas/";
jQuery(function($){
          ...
          if($("#" + data.objetivo).attr("mode") == "main"){
            ...
            if($( "#" + data.objetivo).attr("class") == "panel panel-chat mini"){
              ...
              $( "#" + data.objetivo + " > .panel-body > ul" ).append('<li>' +
                  '<img src="' + URL_SERVER_ADMIN + 'images/bus icono.png" alt=""/>' +
                    ...
                    if($.trim(resultado) != ""){
                      ...
                      .done(function( dato ) {
                        if($.trim(dato) != ""){
                          ...
                          if(con == 0){
                            var usuarioSesion = $("#txtUserId").val();
                            jsonChats[jsonChats.length] = {origen: data.objetivo, destino: usuarioSesion, usuarioF: data.usuarioS, usuarioS: data.usuarioF, tipo:"ACUDIENTE", estudiantes: jsonDatos[0].idEstudiantes}
                      ...
                      if($("#chats > div").length < 2){
                        ...
                        if(jsonDatos[0].gcm_regid != ""){
                          imagen = URL_SERVER_ADMIN + "images/circle_green_16_ns.png";
                        }else{
                          imagen = URL_SERVER_ADMIN + "images/circle_red_16_ns.png";
                        }
                        ...
                        $("#chats").append('<div class="panel panel-chat" style="margin-right:' + marginRight + 'px" id="' + data.objetivo + '" estudiantes="' + jsonDatos[0].idEstudiantes + '" persona="' + data.usuarioS + '" mode="main">' +
                          '<div class="panel-heading" align="center">' +
                              '<img src="' + imagen + '" style="float: left; margin-left: 0">' +
                              '<span>ACUDIENTE: ' + jsonDatos[0].PrimerNombre + ' ' + jsonDatos[0].SegundoNombre + ' ' + jsonDatos[0].PrimerApellido + ' ' + jsonDatos[0].SegundoApellido + ' (' + jsonDatos[0].Estudiantes + ')</span>' +
                              '<a href="#" class="chatClose" onclick="return false" style="float: right; margin-right: 0; color: #FFF" persona="' + data.objetivo + '" personaS="' + data.usuarioS + '" tipo="ACUDIENTE"><i class="glyphicon glyphicon-remove"></i></a>' +
                          '</div>' +
                          ...
                          '<table width="100%" cellpadding="0" cellpadding="0">' +
                              '<tr>' +
                                  ...
                                  '<td width="5%"><button type="button" data-inline="true" data-mini="true" id="btnEnviar' + data.objetivo + '" persona="' + data.objetivo + '" estudiantes="' + jsonDatos[0].idEstudiantes + '" personaS="' + data.usuarioS + '" tipo="ACUDIENTE" class="btn btn-primary">></button></td>' +
                              '</tr>' +
                          '</table>' +
                        '</div>')
                        ...
                        $( ".windowHidden > li > ul" ).append('<li id="' + data.objetivo + '" mode="hidden" estudiantes="' + jsonDatos[0].idEstudiantes + '" persona="' + data.usuarioS + '">ACUDIENTE: ' + jsonDatos[0].PrimerNombre + ' ' + jsonDatos[0].SegundoNombre + ' ' + jsonDatos[0].PrimerApellido + ' ' + jsonDatos[0].SegundoApellido + ' (' + jsonDatos[0].Estudiantes + ')</li>'); 
                        $('.windowHidden > li > a').css({"background": "orange", "border": "1px solid orange"})
                        $( "#" + data.objetivo).css({"background": "orange", "border": "1px solid orange"})
                        ...
                        $(".windowHidden > li > ul > li").click(function(){
                          ...
                          $("#chats").append('<div class="panel panel-chat" style="margin-right:360px;" id="' + idSelect + '" estudiantes="' + estudiantesSelect + '" persona="' + personaSelect + '" mode="main">' +
                              '<div class="panel-heading" align="center">' +
                                  '<img src="' + URL_SERVER_ADMIN + 'images/circle_green_16_ns.png" style="float: left; margin-left: 0">' +
                                  '<span>' + spanSelect + '</span>' +
                                  '<a href="#" class="chatClose" onclick="return false" style="float: right; margin-right: 0; color: #FFF" persona="' + idSelect + '" tipo="ACUDIENTE" personaS="' + personaSelect + '"><i class="glyphicon glyphicon-remove"></i></a>' +
                              '</div>' +
                              '<div class="panel-body">' +
                                  '<br>' +
                                  '<ul>' +
                              ...
                              '<table width="100%" cellpadding="0" cellpadding="0">' +
                                  '<tr>' +
                                      ...
                                      '<td width="5%"><button data-inline="true" data-mini="true" id="btnEnviar' + idSelect + '" persona="' + idSelect + '" estudiantes="' + estudiantesSelect + '" tipo="ACUDIENTE" personaS="' + personaSelect + '" class="btn btn-primary">></button></td>' +
                                  '</tr>' +
                              '</table>' +
                          '</div>')
                          var usuarioSesion = $("#txtUserId").val();
                    ...
                    if($("#chats > div").length < 2){
                      ...
                      $("#chats").append('<div class="panel panel-chat" style="margin-right:' + marginRight + 'px" id="' + data.objetivo + '" persona="' + data.usuarioS + '" mode="main">' +
                        '<div class="panel-heading" align="center">' +
                            ...
                            '<a href="#" class="chatClose" onclick="return false" style="float: right; margin-right: 0; color: #FFF" tipo="MONITOR" persona="' + data.objetivo + '" personaS="' + data.usuarioS + '"><i class="glyphicon glyphicon-remove"></i></a>' +
                        '</div>' +
                        '<div class="panel-body">' +
                            '<br>' +
                            '<ul>' +
                        ...
                        '<table width="100%" cellpadding="0" cellpadding="0">' +
                            '<tr>' +
                                '<td width="95%"><input name="textMessage' + data.objetivo + '" id="textMessage' + data.objetivo + '" cols="0" rows="0" onkeypress="validar(event)" class="form-control" /></td>' +
                                '<td width="5%"><button type="button" data-inline="true" data-mini="true" id="btnEnviar' + data.objetivo + '" tipo="MONITOR" persona="' + data.objetivo + '" personaS="' + data.usuarioS + '" class="btn btn-primary">></button></td>' +
                            '</tr>' +
                        '</table>' +
                      '</div>')
                      ...
                      $(".windowHidden > li > ul > li").click(function(){
                        ...
                        $("#chats").append('<div class="panel panel-chat" style="margin-right:360px;" id="' + idSelect + '" persona="' + personaSelect + '" mode="main">' +
                            '<div class="panel-heading" align="center">' +
                                '<img src="' + URL_SERVER_ADMIN + 'images/circle_green_16_ns.png" style="float: left; margin-left: 0">' +
                                '<span>' + spanSelect + '</span>' +
                                '<a href="#" class="chatClose" onclick="return false" style="float: right; margin-right: 0; color: #FFF" persona="' + idSelect + '" tipo="MONITOR" personaS="' + persona + '"><i class="glyphicon glyphicon-remove"></i></a>' +
                            '</div>' +
                            '<div class="panel-body">' +
                                '<br>' +
                                '<ul>' +
                            ...
                            '<table width="100%" cellpadding="0" cellpadding="0">' +
                                '<tr>' +
                                    '<td width="95%"><input name="textMessage' + idSelect + '" id="textMessage' + idSelect + '" cols="0" rows="0" onkeypress="validar(event)" class="form-control" /></td>' +
                                    '<td width="5%"><button data-inline="true" data-mini="true" id="btnEnviar' + idSelect + '" persona="' + idSelect + '" tipo="MONITOR" personaS="' + persona + '" class="btn btn-primary">></button></td>' +
                                '</tr>' +
                            '</table>' +
                        '</div>')
              ...
              case "ACUDIENTE":
                  ...
                  .done(function( resultado ) {console.log(resultado)
                    ...
                    if($.trim(resultado) != ""){
                      ...
                      $("#chats").append('<div class="panel panel-chat" style="margin-right:0px" id="' + data.objetivo + '" estudiantes="' + jsonDatos[0].idEstudiantes + '" persona="' + data.usuarioS + '" mode="main">' +
                        '<div class="panel-heading" align="center">' +
                            '<img src="' + imagen + '" style="float: left; margin-left: 0">' +
                            '<span>ACUDIENTE: ' + jsonDatos[0].PrimerNombre + ' ' + jsonDatos[0].SegundoNombre + ' ' + jsonDatos[0].PrimerApellido + ' ' + jsonDatos[0].SegundoApellido + ' (' + jsonDatos[0].Estudiantes + ')</span>' +
                            '<a href="#" class="chatClose" onclick="return false" style="float: right; margin-right: 0; color: #FFF" tipo="ACUDIENTE" persona="' + data.objetivo + '" personaS="' + data.usuarioS + '"><i class="glyphicon glyphicon-remove"></i></a>' +
                        '</div>' +
                        '<div class="panel-body">' +
                            '<br>' +
                            '<ul>' +
                        ...
                        '<table width="100%" cellpadding="0" cellpadding="0">' +
                            '<tr>' +
                                '<td width="95%"><input name="textMessage' + data.objetivo + '" id="textMessage' + data.objetivo + '" cols="0" rows="0" onkeypress="validar(event)" class="form-control" /></td>' +
                                '<td width="5%"><button type="button" data-inline="true" data-mini="true" id="btnEnviar' + data.objetivo + '" estudiantes="' + jsonDatos[0].idEstudiantes + '" tipo="ACUDIENTE" persona="' + data.objetivo + '" personaS="' + data.usuarioS + '" class="btn btn-primary">></button></td>' +
                            '</tr>' +
                        '</table>' +
                      '</div>')
    ...
    socket.on('user joined', function (datos) {
      if(datos.username != null){
        var specialChars = "!@#$^&%*()+=-[]\/{}|:<>?,.";
        var usuarioSesion = datos.username;
        // Los eliminamos todos
        for (var i = 0; i < specialChars.length; i++) {
          usuarioSesion= usuarioSesion.replace(new RegExp("\\" + specialChars[i], 'gi'), '');
        }
        if($("#" + usuarioSesion).length > 0){
          $("#" + usuarioSesion + " > .panel-heading > img").attr("src", URL_SERVER_ADMIN + "images/circle_green_16_ns.png")
        }
      }

      
      console.log(JSON.stringify(datos) + " " + datos.length)   
    });

    socket.on('user left', function (dat) {
      if(dat.username != null){
        var specialChars = "!@#$^&%*()+=-[]\/{}|:<>?,.";
        var usuarioSesion = dat.username;
        // Los eliminamos todos
        for (var i = 0; i < specialChars.length; i++) {
          usuarioSesion= usuarioSesion.replace(new RegExp("\\" + specialChars[i], 'gi'), '');
        }
        if($("#" + usuarioSesion).length > 0){
          $("#" + usuarioSesion + " > .panel-heading > img").attr("src", URL_SERVER_ADMIN + "images/circle_red_16_ns.png")
        }
      }
    ...
    if($(".windowHidden > li > ul > li").length != 0){
      ...
      $("#chats").append('<div class="panel panel-chat" style="margin-right:360px;" id="' + idSelect + '" persona="' + personaSelect + '" mode="main">' +
          ...
          '<table width="100%" cellpadding="0" cellpadding="0">' +
              '<tr>' +
                  '<td width="95%"><input name="textMessage' + idSelect + '" id="textMessage' + idSelect + '" cols="0" rows="0" onkeypress="validar(event)" class="form-control" /></td>' +
                  '<td width="5%"><button data-inline="true" data-mini="true" id="btnEnviar' + idSelect + '" estudiantes="' + estudiantesSelect + '" persona="' + idSelect + '" tipo="" personaS="' + personaSelect + '" class="btn btn-primary">></button></td>' +
              '</tr>' +
          '</table>' +
      '</div>')
...
function init(){
  ...
  $("#chats").append('<div class="panel panel-chat" estudiantes="" style="margin-right:360px" id="1" mode="main" persona="">' +
    '<div class="panel-heading" align="center">' +
        '<img src="../../images/circle_green_16_ns.png" style="float: left; margin-left: 0">' +
          ...
          if(jsonChats[i].destino == $("#txtUserId").val()){  
            if(jsonChats[i].tipo){
              switch(jsonChats[i].tipo){
                  case "ACUDIENTE":
                      var imagen = "";
                      if(jsonChats[i].Online == "SI"){
                        imagen = URL_SERVER_ADMIN + "images/circle_green_16_ns.png";
                      }else{
                        imagen = URL_SERVER_ADMIN + "images/circle_red_16_ns.png";
                      }
                      if(contador == 0){  
                          $("#chats").append('<div class="panel panel-chat" style="margin-right:0px" id="' + jsonChats[i].origen + '" persona="' + jsonChats[i].usuarioF + '" estudiantes="' + jsonChats[i].estudiantes + '" mode="main">' +
                              '<div class="panel-heading" align="center">' +
                                  '<img src="' + imagen + '" style="float: left; margin-left: 0">' +
                                  '<span>ACUDIENTE: ' + jsonChats[i].NombreAcudiente + ' (' + jsonChats[i].Nombre + ')</span>' +
                              ...
                              '<table width="100%" cellpadding="0" cellpadding="0">' +
                                  '<tr>' +
                                      ...
                                      '<td width="5%"><button data-inline="true" data-mini="true" id="btnEnviar' + jsonChats[i].origen + '" estudiantes="' + jsonChats[i].estudiantes + '" persona="' + jsonChats[i].origen + '" tipo="' + jsonChats[i].tipo + '" personaS="' + jsonChats[i].usuarioF + '" class="btn btn-primary">></button></td>' +
                                  '</tr>' +
                              '</table>' +
                          '</div>')
                          ...
                          if(contador == 1){  
                              $("#chats").append('<div class="panel panel-chat" style="margin-right: 360px" id="' + jsonChats[i].origen + '" id="' + jsonChats[i].origen + '" estudiantes="' + jsonChats[i].estudiantes + '" persona="' + jsonChats[i].usuarioF + '" mode="main">' +
                                  '<div class="panel-heading" align="center">' +
                                      '<img src="' + imagen + '" style="float: left; margin-left: 0">' +
                                      '<span>ACUDIENTE: ' + jsonChats[i].NombreAcudiente + ' (' + jsonChats[i].Nombre + ')</span>' +
                                      '<a href="#" class="chatClose" onclick="return false" style="float: right; margin-right: 0; color: #FFF" persona="' + jsonChats[i].origen + '" tipo="' + jsonChats[i].tipo + '" personaS="' + jsonChats[i].usuarioF + '"><i class="glyphicon glyphicon-remove"></i></a>' +
                              ...
                              $(".windowHidden > li > ul > li").click(function(){
                                ...
                                $("#chats").append('<div class="panel panel-chat" style="margin-right:360px;" id="' + idSelect + '" estudiantes="' + estudiantesSelect + '" persona="' + personaSelect + '" mode="main">' +
                                    ...
                                    '<table width="100%" cellpadding="0" cellpadding="0">' +
                                        '<tr>' +
                                            '<td width="95%"><input name="textMessage' + idSelect + '" id="textMessage' + idSelect + '" cols="0" rows="0" onkeypress="validar(event)" class="form-control" /></td>' +
                                            '<td width="5%"><button data-inline="true" data-mini="true" id="btnEnviar' + idSelect + '" persona="' + idSelect + '" estudiantes="' + estudiantesSelect + '" tipo="" personaS="' + personaSelect + '" class="btn btn-primary">></button></td>' +
                                        '</tr>' +
                                    '</table>' +
                                '</div>')
                                var usuarioSesion = $("#txtUserId").val();
