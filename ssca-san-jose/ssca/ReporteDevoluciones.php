...
<?php
	...
	<table id="demo" width="100%">
      ...
      <script type="text/javascript">
        ...
        */
        ...
        $("#btnGenerarReporte").click(function(e) {
			...
			var usuarioSeleccionado = $("#usuarioSesion").html();
      ...
      $.post("ActionReporteDevoluciones.php", usuario)
      ...
      $("#btnExportarReporte").click(function(e) {
        ...
        var fechaInicial = $("#dateFechaInicial").val();
        var fechaFinal = $("#dateFechaFinal").val();
        var win = window.open("exportarDevoluciones.php?usuario=" + usuarioSeleccionado + "&fechaInicial=" + fechaInicial + "&fechaFinal=" + fechaFinal, '_blank');
        win.focus();  
