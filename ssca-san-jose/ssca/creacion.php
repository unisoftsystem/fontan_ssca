...
#right-panel i {
  font-size: 12px;
    ...
    #contenedor {height: 400px;margin:0;position:relative;top:30px;}
    #col_der, #col_izq, #col_cen {height: 100%;}
    #col_der {float: right; width: 40%;}
    #col_izq {float: left; width: 300px; top: 40px;POSITION: absolute; left: 40px;}
    #col_cen { padding-left:30%;}
