...
<head>
<meta charset="utf-8">
<title>Devolución de Saldo</title>
          ...
          <br/>
              <div class="row">
                  ...
                  <div class="col-md-4">
                      ...
                      <label for="txtRecarga">Saldo Actual:</label>
                      <input type="text" name="txtSaldo" id="txtSaldo" class="form-control" disabled/>
                      <label for="txtRecarga">Devolver:</label>
                      <input type="text" name="txtRecarga" id="txtRecarga" min="1" onKeyUp="format(this)" class="form-control"/><br>
                      <button type="button" name="btnIngresar" id="btnIngresar" class="btn btn-primary" style="float: right;"><b>Realizar Devolucion</b></button>
                  </div>
              </div>
          </div>
...
<script type="text/javascript">
  ...
  */
  ...
  $('#close').click(function(){
       ...
       window.location.href = "DevolucionSaldo.php";
        return false;
    }); 
    ...
    if($.trim(saldoActual) != ""){
      if(parseInt(vaux) > 0){
        if(parseInt(vaux) <= parseInt(saldoActual)){
          ...
          $.post("ActionDevolucionSaldo.php", usuario)
          .done(function( data ) {
