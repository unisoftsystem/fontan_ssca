  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
     ...
     <body onLoad="load();"  onunload="GUnload();">
		...
		<div class="col-lg-12">
		<input class="form-control" type="text" id="direccion" name="direccion" value=""/><button type="submit" id="pasar" class="btn btn-primary pull-right">Obtener coordenadas <span class="fa fa-arrow-right"></span></button>
	    </div> 
		</p>
		...
		<p><label>Identificacion:</label></br></p>
		<div class="col-lg-12">	
			<input type="number" class="form-control" required  name="est" id="est"/>
		</div>	
