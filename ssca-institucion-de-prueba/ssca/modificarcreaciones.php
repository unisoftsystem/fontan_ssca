...
<script>
   //duplicado de id
      $(document).ready(function () {
          $("#asignacionruta").keyup(function () {
              var value = $(this).val();
              $("#asignacionrutas").val(value);
          });
      });
</script>
<script>
...
<script type="text/javascript">
           $(document).ready(function(){
               $("#asignacionruta").change(function(){
                     var asignacionruta=$("#asignacionruta").val();
                     $.ajax({
                        type:"post",
                        url:"findcreaciones.php",
                        data:"asignacionruta="+asignacionruta,
                        success:function(data){
                        	$("#divDrag").html("");
							contadorColumnasAgregadas = 1;
							contadorFilasAgregadas = 1;
							console.log(data);
							//Convertir a un objeto json el resultado, Claro esta el resultado de la conexion al webservice debe ser una cadena en formato json
							var jsonDatos = JSON.parse(data);
							localStorage.setItem("idRutaResultado",asignacionruta); 
							$("#txtNombre").val(jsonDatos[0].nombreruta);
							$("#direccion").val(jsonDatos[0].latorigen + "," + jsonDatos[0].longorigen);
							$("#direccions").val(jsonDatos[0].latdestino + "," + jsonDatos[0].longdestino);
							$('#ruta > option[value="' + jsonDatos[0].idruta + '"]').attr('selected', 'selected');
							$('#conductor > option[value="' + jsonDatos[0].id_conductor + '"]').attr('selected', 'selected');
							$('#monitor > option[value="' + jsonDatos[0].monitor + '"]').attr('selected', 'selected');
							var date = new Date();
							...
							var datos = {
								idRuta: asignacionruta,
								fecha: fechaActual
							}
							EnviarDatos(datos, "ActionListarEstudiantesRuta.php", "LISTARESTUDIANTES");
							//alert(jsonDatos[0].latorigen + "," + jsonDatos[0].longorigen);
							var latLng = new google.maps.LatLng(jsonDatos[0].latorigen,jsonDatos[0].longorigen);
							...
							var latLng1 = new google.maps.LatLng(jsonDatos[0].latdestino,jsonDatos[0].longdestino);
							...
							var myOptions1 = {
							  ...
							  //creamos el mapa con las opciones anteriores y le pasamos el elemento div
							   map1 = new google.maps.Map(document.getElementById("map_canvass"), myOptions1);
      ...
      <h3 class="text-primary">
        Selección Ruta
          ...
          <hr>
            ...
            <div class="form-group">
                 <select class="form-control" id="asignacionruta" name="asignacionruta" onkeyup="ajax_search();" > 
                    <?php
                        ...
                        ?>
                        <option id="asignacionruta"  value="<?php echo($row['id'])?>" onkeyup="ajax_search();" >
            ...
            <input type="hidden" class="form-control" id="asignacionrutas" name="asignacionrutas" readonly >       
		</div>
        ...
        <div class="col-md-4">
			...
			<form role="form" id="google" name="google" action="#">
				<div class="form-group">
					<input class="form-control" type="text" id="direccion" name="direccion" value=""/>
			...
			<form role="form" id="google" name="google" action="#">
				<div class="form-group">
                    <input class="form-control" type="text" id="direccions" name="direccions" value=""/>
            ...
            <div class="form-group">
                <button type="button" id="btnCrearRuta" class="btn btn-primary pull-right">Modificar ruta<span class="fa fa-arrow-right"></span></button>
            </div>
		</div>
					...
					$(function($){
						...
						$("#btnCrearRuta").click(function(e) {
							...
							if($.trim(nombreruta) != ""){
								...
								EnviarDatos(datos,"ActionModificarRuta.php","MODIFICARRUTA");
							}
                        });
