...
<?php
    ...
    // mysql select
    $result = mysql_query("SELECT * FROM  `movimientos` INNER JOIN ordenpedido ON movimientos.idCredencial = ordenpedido.idCredencial WHERE YEARWEEK( FechaMovimiento ) = YEARWEEK( CURRENT_date ) GROUP BY  `DescripcionPedido` ORDER BY  `DescripcionPedido` DESC LIMIT 0 , 10");         
?>
<!doctype html>
<html>
    <head>
    ...
    <body id="bodyBase">
      ...
      <div align="right">
      <h3>Tendencia de Consumo Semana&nbsp;&nbsp;&nbsp;</h3>
      </div>
      <div align="right">
      ...
      <button type="button" class="btn btn-warning" onclick="window.location.href='/ssca/ReporteTendenciasMes.php'">Reporte Tendencias Mes</button>
      </div>
